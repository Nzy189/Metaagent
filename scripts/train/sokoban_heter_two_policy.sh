...
python3 -m pettingllms.trainer.train --config-path ../config/stateful --config-name plan_path_two_policies \
    $total_resource \
    experiment_name=sokoban_heter_instruct+instruct \
    $model_0_USE_GRPO $model_0_resource $model_0_data \
    $model_1_USE_GRPO $model_1_resource $model_1_data \
    +parallel=False \
    models.model_0.path=/home/lah003/models/Qwen2.5-0.5B-Instruct \
    models.model_1.path=/home/lah003/models/Qwen2.5-0.5B-Instruct \
