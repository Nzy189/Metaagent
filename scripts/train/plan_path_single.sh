...
python3 -m pettingllms.trainer.train --config-path ../config/stateful --config-name stateful_two_policies \
    $model_0_USE_GRPO $model_0_resource\
    models.model_0.path=/home/lah003/models/Qwen3-1.7B\
    experiment_name=stateful_two_policies_1.7B\
    if_dapo=True\
    benchmark=plan_path\
