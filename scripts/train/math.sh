...
model_0_resource="resource.n_gpus_per_node=6  $model_0_config_path.trainer.n_gpus_per_node=6 $model_0_config_path.trainer.nnodes=1 $model_0_config_path.actor_rollout_ref.rollout.tensor_model_parallel_size=6"
